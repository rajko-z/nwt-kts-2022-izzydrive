...
VALUES (5614.2, 'ACTIVE', 441.2, '2023-01-16 18:10:00', false, null, 250, '2023-01-16 18:00:00', 1, null, null, false, 1, 0, 0);

update drivers set current_driving_id=1 where id=1;
update passengers set current_driving_id=1 where id=9; --bob current driving
