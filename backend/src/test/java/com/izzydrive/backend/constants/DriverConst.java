...
public class DriverConst {
    ...
    public static final String D_MILAN_EMAIL = "milan@gmail.com";
    public static final String D_PETAR_EMAIL = "petar@gmail.com";
    ...
    public static final Long D_PREDRAG_ID = 3L;
